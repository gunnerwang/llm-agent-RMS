        ...
        "objects_in_room" : {
                ...
                "items" : {
                    ...
                    "properties" : {
                        ...
                        "facing" : {
                            "type" : "string",
                            "description" : "The wall this object is facing. Must be one of: north_wall, south_wall, east_wall, west_wall."
                        },
                        "placement" : {
                                        ...
                                        "objects_in_room" : {
                                            ...
                                            "items" : {
                                                ...
                                                "properties" : {
                                                    ...
                                                    "preposition" : {
                                                        "type" : "string",
                                                        "description" : "The preposition that connects this object and the connected object. 'object_id' is 'preposition' 'object_id' . Ex. lamp_1 is left of desk_1, table_1 is behind the bed_1, rug_1 is under desk_1 (a rug is never 'on' or 'above' another object)...",
                                                        "enum" : ["on", "left of", "right of", "in front", "behind", "under", "above", "through"]
                                                    },
                                                    "is_adjacent" : {
                                                        "type" : "boolean",
                        ...
                        "connections" : {
                            "type" : ["array", "null"],
                            "description" : "Physical connections between this object and others (conveyor links). Defines material flow.",
                            "items" : {
                                "type" : "object",
                                "properties" : {
                                    "object_id" : {
                                        "type" : "string",
                                        "description" : "The id of the connected object."
                                    },
                                    "connection_type" : {
                                        "type" : "string",
                                        "description" : "Type of connection: 'connected' for straight, 'connected_corner' for 90-degree turns."
                                    },
                                    "source_endpoint" : {
                                        "type" : "string",
                                        "description" : "Endpoint on THIS object. Values: 'primary_forward_positive' (front), 'primary_forward_negative' (back), 'right_negative' (side T-branch), 'forward_positive'/'forward_negative' (for corners)."
                                    },
                                    "target_endpoint" : {
                                        "type" : "string",
                                        "description" : "Endpoint on the TARGET object. Same value options as source_endpoint."
                                    }
                                },
                                "required" : ["object_id", "connection_type", "source_endpoint", "target_endpoint"]
                            }
                        }
                    },
...
engineer_schema = json.dumps(initial_schema, indent=4)
