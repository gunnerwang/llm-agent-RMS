...
for obj_in_room in objects_in_room:
    if "style" in obj_in_room and "material" in obj_in_room:
        ...
        continue
    text = preprocess("A high-poly " + obj_in_room['object_id']) + f" with {material} material and in {style} style, high quality"
    ...
    move_files(objaverse_objects, destination_folder, obj_in_room['object_id'])