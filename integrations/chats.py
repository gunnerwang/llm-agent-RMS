...
class GroupChat(GroupChat):
    ...
    def select_speaker(self, last_speaker: Agent, selector: AssistantAgent):
        ...
        if last_speaker_name == "Admin":
            return self.agent_by_name("Process_planner")
        elif last_speaker_name == "Process_planner":
            return self.agent_by_name("Layout_engineer")
        elif last_speaker_name == "Layout_engineer":
